...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <input type="hidden" name="uname" value="${admin.name}" >
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    <label class="layui-form-label">申请简介：</label>
    <div class="layui-input-block">
      <input type="text" name="content" class="layui-input width400 name" value="" lay-verify="required" placeholder="请输入申请简介">
    </div>
  </div>
    ...
    var form = layui.form
        ...
        form.on("submit(add)",function(data){
            ...
            var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
            	$.ajax({
                      url:'http://localhost:8080/xuanke/admin/order/add',
                      type:'post',           //post提交
